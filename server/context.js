...
const ctx = {
  ...
  network: {
    ...
    TERRACOTTA_ERROR_MAP: {
      1: { key: '配置错误', msg: '请检查网络设置或房间码是否正确' },
      2: { key: '网络错误', msg: '无法连接到联机节点，请检查网络或切换节点' },
      3: { key: '版本不兼容', msg: 'Terracotta 版本不兼容，请尝试更新组件' },
      4: { key: '房间已满', msg: '房间人数已达上限' },
      5: { key: '房间不存在', msg: '房间码无效或房间已关闭' },
      6: { key: '密码错误', msg: '房间密码错误' },
      7: { key: '被踢出', msg: '你已被房主移出房间' },
      8: { key: '连接超时', msg: '连接超时，请检查网络或重试' },
      9: { key: '服务器关闭', msg: '联机服务器已关闭' },
      10: { key: '协议错误', msg: '通信协议错误，请重试' }
    },

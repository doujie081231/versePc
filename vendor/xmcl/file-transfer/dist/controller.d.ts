...
declare const kManagedAbort: unique symbol;
/**
 ...
 */
export declare class ManagedAbortError extends Error {
    readonly [kManagedAbort] = true;
    readonly reason: ManagedAbortReason;
    constructor(reason?: ManagedAbortReason);
}
export declare function isManagedAbortError(e: unknown): e is ManagedAbortError;
declare const kRangeUnsupported: unique symbol;
/**
...
export declare function isRangeNotSupportedError(e: unknown): e is RangeNotSupportedError;
export {};
